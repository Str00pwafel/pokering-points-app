...
__changelog__ = {
    "2.2.0": [
        ...
        "CI: Jenkins infrastructure endpoints parameterized via POKERING_GIT_URL / POKERING_ANSIBLE_TARGET / POKERING_ANSIBLE_DIR global env vars",
        "CI: Jenkins deploys only on v* release tags — pushing main runs lint/tests/audit and stops; pushing a tag is the deliberate ship action",
    ...
    "2.1.2": [
        ...
        "Packages: update Uvicorn to 0.49.0 and Ruff to 0.15.16; allow pip-audit 2.9+",
